...
let favoriteFoods = [ 'mafé', 'chawarma', 'hot-dog', 'salad', 'mac and cheese'];
...
console.log('Number of foods are', numberOfFoods);
...
gems.sort();
gems.reverse();
console.log('sorted array in reverse alphabetical order is ', gems);
